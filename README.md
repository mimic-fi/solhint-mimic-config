...
<p align="center">
  <a href="https://badge.fury.io/js/solhint-config-mimic">
    <img src="https://badge.fury.io/js/solhint-config-mimic.svg" alt="NPM">
  </a>
...
This repository contains the solhint rules shared among all the Mimic repositories.
...
$ git clone https://github.com/mimic-fi/solhint-mimic-config

# Go into the repository
$ cd solhint-mimic-config
